...
# For "make install"
INSTALL_LIB = ${ssa_SOURCE_DIR}/EXTERNAL/SuiteSparse/lib
INSTALL_INCLUDE = ${ssa_SOURCE_DIR}/EXTERNAL/SuiteSparse/include
...
BLAS = -L${ssa_SOURCE_DIR}/EXTERNAL/OpenBLAS2 -lopenblas -lgfortran
LAPACK = 
#-llapack
