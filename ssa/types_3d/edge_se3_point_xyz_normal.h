...
#ifndef __SSA_EDGE_SE3_POINT_XYZ_NORMAL__
#define __SSA_EDGE_SE3_POINT_XYZ_NORMAL__
...
namespace ssa {
  ...
  class EdgeSE3PointXYZNormal : public g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSE3, VertexPointXYZNormal>
  {
    public:
      EIGEN_MAKE_ALIGNED_OPERATOR_NEW

      EdgeSE3PointXYZNormal();
      ~EdgeSE3PointXYZNormal();

      void computeError()
      {
        const g2o::VertexSE3* v1 = dynamic_cast<const g2o::VertexSE3*>(vertices()[0]);
        const VertexPointXYZNormal* l2 = dynamic_cast<const VertexPointXYZNormal*>(vertices()[1]);
