...
int main(int argc, char **argv)
{
  ...
  SparseSurfaceAdjustmentT<g2o::EdgeSE3, ssa::EdgeSE3PointXYZNormal, ssa::EdgePointXYZNormalPointXYZNormal> ssa;
  ssa.setVerbose(true);
...
// 	  RepresentativeSubsetT<g2o::EdgeSE3, ssa::EdgeSE3PointXYZNormal, ssa::EdgePointXYZCovPointXYZCov> subset;
